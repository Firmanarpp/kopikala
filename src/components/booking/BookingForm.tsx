...
export default function BookingForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      {/* Time */}
      <div>
        <label htmlFor="time" className="block text-sm font-medium text-stone-700 dark:text-stone-300 mb-2">
          Jam Reservasi
        </label>
        <select
          id="time"
      ...
      {/* Guests */}
      <div>
        <label htmlFor="guests" className="block text-sm font-medium text-stone-700 dark:text-stone-300 mb-2">
          Jumlah Orang
        </label>
        <select
          id="guests"
      ...
      <p className="text-center text-sm text-stone-500 dark:text-stone-400">
        Anda akan diarahkan ke WhatsApp untuk konfirmasi reservasi
      </p>
    </form>
  );
}
