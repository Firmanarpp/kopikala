...
export const metadata: Metadata = {
  title: 'Kontak',
  description: 'Hubungi KopiKala. Temukan alamat, nomor telepon, email, dan jam operasional kami. Kami siap melayani Anda.',
  keywords: ['kontak', 'alamat', 'lokasi', 'coffee shop jakarta', 'kopikala'],
};

const contactInfo = [
  {
    title: 'Alamat',
    content: 'Jl. Kopi Nikmat No. 123, Jakarta Selatan, DKI Jakarta 12345',
    icon: (
      ...
      <section className="py-16 bg-stone-50 dark:bg-stone-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 gap-4">
                {contactInfo.map((info, index) => (
                  <div
                    key={index}
                    className="bg-white dark:bg-stone-800 rounded-xl p-6 shadow-lg flex items-start space-x-4"
                  >
                    ...
                    <div>
                      ...
                      {info.href ? (
                        <a
                          href={info.href}
                          className="text-stone-600 dark:text-stone-400 hover:text-amber-600 dark:hover:text-amber-500 transition-colors"
                        >
                          {info.content}
                        </a>
                      ) : (
              ...
              <div className="bg-white dark:bg-stone-800 rounded-xl p-6 shadow-lg">
                <h3 className="font-semibold text-stone-800 dark:text-white mb-4 flex items-center">
            ...
            {/* Contact Form */}
            <div className="bg-white dark:bg-stone-800 rounded-2xl p-8 shadow-xl h-fit">
      ...
      <section className="py-16 bg-white dark:bg-stone-800">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-stone-600 dark:text-stone-400 mb-8">
            Dapatkan update terbaru tentang menu baru, promo, dan event di KopiKala.
          </p>
          <div className="flex justify-center space-x-6">
            <a
              ...
              className="w-14 h-14 bg-gradient-to-br from-purple-600 via-pink-600 to-orange-500 rounded-full flex items-center justify-center text-white hover:scale-110 transition-transform"
            ...
            <a
              href="https://tiktok.com/@kopikala.coffee"
              target="_blank"
              rel="noopener noreferrer"
              className="w-14 h-14 bg-black rounded-full flex items-center justify-center text-white hover:scale-110 transition-transform"
              aria-label="TikTok"
            >
              <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a
              href="https://facebook.com/kopikala.coffee"
              target="_blank"
              rel="noopener noreferrer"
